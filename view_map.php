		...
		<br><br>
            <div style="padding: 2px;" class="<?php echo $mostrar_barra;?>">
                <div class="pull-right">
                    <a class="btn btn-primary" <?php $site_urll=site_url('calidad/editMapa/').$mapa->idMapa;?> href="<?php echo $site_urll; ?>">
			...
			<div class="col-lg-12">
                <table class="table-bordered" style="margin-top:30px;">
                    <tr>
                        ...
                        <td class="col-sm-8" rowspan="2"><center><h4><b>CRM CONSULTING SERVICES S.A.S</b></h4></center></td>
                        <td class="col-sm-4" ><b>Código:</b>
                            <div style="width: 220px; height:1px;">
                            </div>
                            <center>
                              <?php echo $mapa->codigoMapa; ?>
                            </center>  
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="3">
                            <div class="row">
                                ...
                                <div class="cuadro">
                                	<img class="img-responsive"  alt="Mapa" src="<?php echo base_url()."img/imagen_mapa/".$mapa->imagen;?>" usemap="#mapa"> 
                                        <map id="mapa" name="mapa">
                                        <?php foreach ($coordenadas as $value) 
                                            {
                                        ?>
                                            <area shape="rect" alt="" title="" coords="<?php echo $value->coordenadas;?>" href="<?php echo base_url()."calidad/gestionDocumental/".$value->codigoProceso;?>" target="" />
                                        <?php  
                                            } 
                                        ?>
                                        </map>
