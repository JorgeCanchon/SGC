        ...
        <div id="page-wrapper">   
            ...
            <div style="padding: 2px;" class="<?php echo $mostrar_barra;?>">
                <div class="pull-right">
                    <a class="btn btn-primary" <?php $site_urll=site_url('calidad/editPolitica/').$politica->idPolitica ?> href="<?php echo $site_urll; ?>">
                    ...
                    <table class="table-bordered" style="margin-top:30px;">
                        <tr>
                            ...
                            <td class="col-sm-4" ><b>Código:</b>
                                ...
                                <center>
                                  <?php echo $politica->codigoPolitica; ?>
                                </center>  
                            </td>
                        </tr>
                        <tr>
