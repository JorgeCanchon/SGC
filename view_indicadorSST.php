        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel"><i class='fa fa-plus'></i> Agregar nuevo indicador SST</h4>
                </div>
                <?php $url=base_url()."calidad/addIndicadorSST";  ?>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <div class="formIndicador">
                            ...
                            <select class="form-control" name="directriz" id="directriz">
                                <?php foreach ($directriz as $dir) {
                                    echo '<option value="'.$dir->id.'">'.$dir->nombreDirectriz.'</option>';
                                } ?>
                            </select>
                        </div>
                        <div class="formIndicador">
                            ...
                            <select class="form-control" name="procesoI" id="procesoI">
                                <?php foreach ($procesos as $process) {
                                    echo '<option value="'.$process->id.'">'.$process->nombreProceso.'</option>';
                                } ?>
                            </select>
                        </div>
                        <div class="formIndicador">
                        ...
                        <div class="formIndicador">
                            <label for="numerador">Numerador formula:</label>
                            <textarea class="form-control" type="text" name="numerador" id="numerador"></textarea>
                        </div>
                        <div class="formIndicador">
                            <label for="denominador">Denominador formula:</label>
    ...
    <div class="modal fade" id="editar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <?php $url=base_url()."calidad/editIndicadorSST";  ?>
    ...
    function validarCampoE(){
        ...
        p = confirm("¿Estas seguro que desea eliminar?");
            ...
            if(p){ 
                 ...
                 window.location="<?php echo base_url()."calidad/inactivateIndicadorSST/"?>"+id;    //ENVIAMOS POR GET EL ID PARA LUEGO RECIBIRLO EN EL CONTROLADOR
             }
        });    
            ...
            $.ajax({
              ...
              alert("error al cargar los datos");
                ...
                success: function (data) {  //EL JSON QUE ENVIAMOS DESDE BUSCAR_PRODUCTOS_ID SE ALMACENA EN DATA 
                    ...
                    //15 numero de elementos distintos a los recursos o responsables de gestionar(Cada vez que se adicione algun elemento a la consulta
