    <div id="wrapper">
        ...
        <br><br>
            <div class="row">
                <div class="col-lg-12">
	                <form action="<?php echo base_url();?>calidad/updateAlcance" method="POST" id="form_editar_alcance" name="form_editar_alcance">
	                	<input type="hidden" name="id" value="<?php echo $idAlcance; ?>">
	                  	<table class="table-bordered" style="margin-top:30px;">
			                    <tr>
			                        ...
			                        <td class="col-sm-4" ><b>Código:</b>
			                            ...
			                            <center>
			                              <input type="text" class="form-control" name="codigoAlcance" id="codigoAlcance" value="<?php echo $alcance->codigoAlcance; ?>" required>
			                            </center>  
									</div>
		                        </td>
		                    </tr>
		                    ...
		                    <tr>
		                        <td colspan="3">
		                            <div class="row">
		                                ...
		                                <div class="cuadro">
		                                	<textarea name="text" id="text" rows="3" class="form-control" required><?php echo $alcance->texto; ?></textarea> 
		                                </div>
		                            </br>               
		                            </div>
		                        </td>         
	                  	...
	                  	<br>
		                <center>
		                <a href="<?php echo base_url();?>calidad/alcance" class="btn btn-default">Cancelar</a>
		                <button type="button" onclick="validarCampo();" value="Enviar" name="enviar" id="enviar" class="btn btn-default">Editar</button>
		                </center>
	                </form>  	
                  <br><br><br><br><br>
                </div>
...
<script type="text/javascript">
	function validarCampo(){
		if(validarCampoVacio('codigoAlcance','Código'))
		{
			return false;
		}
		if(validarCampoVacio('text','Alcance'))
		{
			return false;
		}
		...
		document.form_editar_alcance.submit();
	}
</script>
