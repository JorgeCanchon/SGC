 ...
 <div id="wrapper">
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                          <li><?php     $site_urll = site_url('calidad/completeActa/').$value->numeroActa; ?><a href="<?php echo $site_urll; ?>">Completar</a></li>
                                          <li class="<?php echo $mostrar_barra;?>">
                                            <a href="#addBookDialogA" data-toggle="modal" data-id="<?php echo $value->numeroActa; ?>" data-toggle="modal" class="open-AddBookDialog" >Eliminar</a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
    ...
    <!-- MODAL ELIMINAR ACTA -->
    <div class="modal fade" id="addBookDialogA" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <div class="row">
                        ...
                        <div class="col-md-2 text-center">
                            <?php   $site_url =site_url('calidad/deleteActaIncompleta') ?>
                            <form action="<?php echo $site_url; ?>" name="form_eliminar" id="form_eliminar" method="POST" accept-charset="utf-8">               
                                <input type="hidden" name="id_actaI" id="id_actaI" value="<?php echo $value->numeroActa; ?>">
