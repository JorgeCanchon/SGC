        ...
        <div id="page-wrapper">   
			...
			<?php 
				foreach ($procesosUsuario as $value_u) {
					if($barra_superior && ($contenidoaccion->idProceso==$value_u->id)){
					 ?>
		            <br>
		            <div style="padding: 2px;">
		                <div class="pull-right">
		                    <a class="btn btn-primary" <?php $site_urll=site_url('calidad/editPlanAccion/').$contenidoaccion->id?> href="<?php echo $site_urll; ?>">
                ...
                <div class="col-lg-12">
	                    <table class="table-bordered" style="margin-top:30px;">
	                        ...
	                        <tr>
	                            <td class="col-sm-4">
	                                ...
	                                <center>
	                                    <?php 
											echo date('d-m-Y', strtotime($contenidoaccion->fechaVigencia)); 
	                                    ?>
	                                </center>  
	                            </td>
	                        </tr> 
	                    ...
	                    <table class="tableActa">
	                    	...
	                    	<tr>
	                    		...
	                    		<td class="tableActaBody" style="text-align:justify;"><?php echo $contenidoaccion->frecuenciaPrimer; ?></td>
