    <div id="wrapper">
        ...
        <br><br>
            <div class="row">
                <div class="col-lg-12">
	                <form action="<?php echo base_url();?>calidad/updatePolitica" method="POST" id="form_editar_politica" name="form_editar_politica">
	                	<input type="hidden" name="id" value="<?php echo $idPolitica; ?>">
	                  	<table class="table-bordered" style="margin-top:30px;">
			                    <tr>
			                        ...
			                        <td class="col-sm-4" ><b>Código:</b>
			                            ...
			                            <center>
			                              <input type="text" class="form-control" name="codigoPolitica" id="codigoPolitica" value="<?php echo $politica->codigoPolitica; ?>" required>
			                            </center>  
									</div>
		                        </td>
		                    </tr>
		                    ...
		                    <tr>
		                        <td class="col-sm-4">
		                            ...
		                            <center>
		                            <?php echo date('d-m-Y', strtotime($politica->fechaVigencia)); ?>
		                            </center>  
		                        </td>
		                    </tr> 
		                    <tr>
		                        <td colspan="3">
		                            <div class="row">
		                                ...
		                                <div class="cuadro">
		                                	<textarea name="text" id="text" rows="3" class="form-control" required><?php echo $politica->texto; ?></textarea> 
		                                </div>
		                            </br>               
		                            </div>
		                        </td>         
	                  	...
	                  	<br>
		                <center>
		                <a href="<?php echo base_url();?>calidad/politica" class="btn btn-default">Cancelar</a>
...
<script type="text/javascript">
	function validarCampo(){
		if(validarCampoVacio('codigoPolitica','Código'))
		{
			return false;
		}
		if(validarCampoVacio('text','Politica'))
		{
			return false;
		}
		...
		document.form_editar_politica.submit();
	}
</script>
